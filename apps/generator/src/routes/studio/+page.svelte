...
<svelte:head>
  <title>Terrain studio — TopoStack</title>
  <meta name="description" content="Turn real-world terrain into layered, laser-ready topographic projects and flat engravings." />
</svelte:head>
