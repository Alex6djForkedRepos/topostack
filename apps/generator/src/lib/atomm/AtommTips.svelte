...
<script lang="ts">
  ...
  const TIPS: Array<{ id: TipId; image: string; title: string; body: string[] }> = [
    ...
    { id: "export", image: exportView, title: "Check the export", body: ["For layered reliefs, set material width and height in Export. Pieces arrange automatically with 3 mm margins and 2 mm spacing; choose Use current layout to finish early. Open in Studio sends one editable SVG of the entire layout. Download includes the artwork, settings and data credits, plus an assembly guide for layered reliefs."] },
