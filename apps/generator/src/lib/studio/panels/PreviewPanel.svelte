<script lang="ts">
  ...
  const { cancelGeneration, dismissPreviewWarning, getFeedbackContext, navigateChoice, shownLength, updateFabrication, updateLocation } = studio;
