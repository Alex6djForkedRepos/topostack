...
<div class="custom-data-view">
  <div class="custom-data-workspace-heading">
    ...
    <span>{nav.section === "charts" ? "Trace a chart to shape a lake bed" : nav.section === "markers" ? "Mark places that matter" : nav.section === "paths" ? "Draw trails and boundaries" : "Bring tracks and places onto your map"}</span>
