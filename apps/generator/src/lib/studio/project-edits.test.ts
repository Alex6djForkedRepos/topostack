...
import { addCustomLine, addCustomLinePoint, addMarker, canAddCustomLine, clampPlaqueSize, plaqueSettings, plaqueText, northArrowMaximumMm, removeCustomLine, removeCustomLinePoint, removeMarker, updateCustomLine, updateCustomLinePoint, updateMarker } from "$lib/studio/project-edits";
