...
function studioStrings(): Set<string> {
  const files = ["lib/studio/App.svelte", "lib/studio/ExportDialog.svelte", "lib/studio/LocationDialog.svelte", "lib/studio/MapCanvas.svelte", "lib/studio/TwoDPreview.svelte", "lib/studio/options.ts", "lib/site/FeedbackButton.svelte"];
