...
const REGIONS: readonly RegionConfig[] = [
  ...
  { slug: "united-states", name: "United States lakes and reservoirs", titleName: "US Lake and Reservoir", split: "state", description: "Surveyed depth data for Crater Lake, Lake Tahoe, Lake Pontchartrain, Lake Washington and hundreds of coastal lakes, plus reservoirs in Texas and Colorado. Make a layered wood lake map or an engraving.", sources: ["usgs-crater-lake-v1", "usgs-lake-tahoe-v1", "usgs-mono-lake-v1", "twdb-texas-reservoirs-v1", "usbr-reservoirs-v1", "noaa-nbs-florida-v1", "noaa-nbs-gulf-coast-v1", "noaa-nbs-atlantic-coast-v1", "noaa-nbs-great-lakes-basin-v1", "noaa-nbs-california-v1", "noaa-nbs-northwest-coast-v1", "noaa-nbs-inland-northwest-v1", "noaa-nbs-alaska-v1", "noaa-nbs-caribbean-v1"], about: "Multibeam surveys from USGS cover Crater Lake, Lake Tahoe and Mono Lake, and reservoir surveys from the Texas Water Development Board and the Bureau of Reclamation cover selected reservoirs. NOAA’s National Bathymetric Source adds measured depths for hundreds of lakes, lagoons and coastal ponds, from Lake Pontchartrain and the St. Johns River lakes to Lake Washington and Lake Pend Oreille; only the surveyed parts are used. Minnesota has its own page." },
];
