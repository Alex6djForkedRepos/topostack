...
import { addLabelObstacles, indexLabelLayer, placeElevationLabelStack, selectElevationLabels, type CoordinatedElevationLabel, placeLabel, placeLinearLabel } from "../annotate/label-placement.js";
