 ...
 */
export function stripPack(job_json: string, on_report: Function): string;

export type InitInput = RequestInfo | URL | Response | BufferSource | WebAssembly.Module;

export interface InitOutput {
  readonly memory: WebAssembly.Memory;
  readonly engineInfo: () => [number, number];
  readonly stripPack: (a: number, b: number, c: any) => [number, number, number, number];
