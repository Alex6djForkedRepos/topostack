/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-file=.dev.vars.example src/worker-configuration.d.ts` (hash: 87710e7d2af4d1f64d9d06cc4fe8b9c9)
// Runtime types generated with workerd@1.20260911.1 2026-08-22 nodejs_compat
interface __BaseEnv_Env {
	MAP_CACHE: R2Bucket;
	VECTOR_DATA: R2Bucket;
	FEEDBACK_EMAIL: SendEmail;
	REQUEST_LIMITER: RateLimit;
	GEOCODE_LIMITER: RateLimit;
	GEOCODE_GLOBAL_LIMITER: RateLimit;
	TERRAIN_GLOBAL_LIMITER: RateLimit;
	FEEDBACK_LIMITER: RateLimit;
	FEEDBACK_GLOBAL_LIMITER: RateLimit;
	AGENT_LIMITER: RateLimit;
	AGENT_GLOBAL_LIMITER: RateLimit;
	ENVIRONMENT: "development" | "production";
	ALLOWED_ORIGINS: "http://localhost:5273,http://127.0.0.1:5273,https://dev.topostack.app,https://dev-topostack.echofoxtrot.works,https://www.atomm.com" | "https://topostack.app,https://topostack.echofoxtrot.works,https://www.atomm.com";
	...
	FEEDBACK_EMAIL_FROM: "feedback@topostack.app";
	PUBLIC_ORIGIN: "https://dev.topostack.app" | "https://topostack.app" | "http://localhost:5273";
...
declare namespace Cloudflare {
	...
	interface DevelopmentEnv {
		...
		DATASET_VERSION: "mapzen-terrarium+protomaps-20260905-z12-v1";
		FEEDBACK_EMAIL_FROM: "feedback@topostack.app";
		PUBLIC_ORIGIN: "https://dev.topostack.app";
		GEOCODER_API_KEY: string;
		FEEDBACK_EMAIL_TO: string;
	}
	interface ProductionEnv {
		...
		DATASET_VERSION: "mapzen-terrarium+protomaps-20260905-z12-v1";
		FEEDBACK_EMAIL_FROM: "feedback@topostack.app";
		PUBLIC_ORIGIN: "https://topostack.app";
		GEOCODER_API_KEY: string;
		FEEDBACK_EMAIL_TO: string;
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "ALLOWED_ORIGINS" | "ALLOWED_ORIGIN_SUFFIXES" | "TERRAIN_ORIGIN" | "GEOCODER_ORIGIN" | "DATASET_VERSION" | "FEEDBACK_EMAIL_FROM" | "PUBLIC_ORIGIN" | "GEOCODER_API_KEY" | "FEEDBACK_EMAIL_TO">> {}
}
