...
const PAGE_CARDS = {
  ...
  "/guides/http-api": { kicker: "Developers", title: "Plan models with the HTTP API", intro: "Send a place and size as JSON; get sheets, scale and a link that builds the model.", media: render(`${EXAMPLES}mount-rainier.webp`), footer: `Mount Rainier, Washington · ${TERRAIN}` },
  "/guides/mcp-server": { kicker: "Developers", title: "Build with the MCP server", intro: "Tools, resources and an in-chat preview for assistants that plan terrain models.", media: shot(`${GUIDES}ai-assistant-preview.webp`, [0, 940, 1360, 560]), footer: `A Mount Rainier plan inside a chat, ready to open in the studio · ${TERRAIN}` },
