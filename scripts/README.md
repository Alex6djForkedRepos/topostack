...
| `survey_enc.py` | Grid a lake's depths from NOAA electronic chart (ENC) cells: contours and soundings from the most detailed cells first, shoreline at 0 m, lakes mostly charted as drying refused (library; piloted on Okeechobee, Champlain and Mead, not yet wired into build-survey-bathymetry.py) | manual: [noaa-chart-lake-coverage-2026-09-24.md](../docs/reports/noaa-chart-lake-coverage-2026-09-24.md) |
